...
#scatter plot with fill by buyer region. geom_point(), fill = Buyer.Region
```{r}
V1_graph <- ggplot(stockX_V1, aes(x = Buyer.Region, y = Sale.Price, color = Buyer.Region, fill = Sneaker.Name, size = Sale.Price)) +
  geom_point()+
  theme(axis.text.x = element_text(angle = 90, hjust =1))+
  labs(x = "Colorway", y = "Resell Price", title = "V1 Sales per State")
